...
class CharacterControllerDemo {
  constructor(params) {
	...
	this._LoadAnimatedModel(params);
...
//   }
  ...
  _LoadAnimatedModel(params) {
    // const params = {
    //   camera: this._camera,
    //   scene: this._scene,
    // }

	console.log("on arrive jusqua _LoadAnimatedModels : params : ", params);
...
//   }
  ...
  _RAF() {
    requestAnimationFrame((t) => {
      ...
      this._threejs.renderer.render(this._scene, this._camera);
